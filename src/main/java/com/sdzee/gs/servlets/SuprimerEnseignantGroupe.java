...
/**
 * Servlet implementation class SuprimerEnseignantGroupe
 */
public class SuprimerEnseignantGroupe extends HttpServlet {
     ...
     */
    public SuprimerEnseignantGroupe() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
					...
					conn.SuprimerEnseignantFromGroupe(id, num);
