<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%@ page import="com.sdzee.gs.db.Connexion,java.io.IOException,java.util.*,java.sql.*,com.sdzee.gs.beans.Etudiant,com.sdzee.gs.beans.Personne" %>
<%
String user="";
...
<p><a href="<c:url value="../../GestionEtudiants.jsp"/>">Annuler</a></p>
</div>
...
try {
	...
	Personne p=conn.RetournerPersonneFromETD(Integer.parseInt(num));
	
%>

<div>
<form method="get" action=" <c:url value="/ModifierEtudiant" />" >
<fieldset>
...
<br />
<label for="num">Numero d'inscription</label>
